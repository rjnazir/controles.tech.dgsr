...
/**
 * @extends ServiceEntityRepository<CtMarque>
 *
...
class CtMarqueRepository extends ServiceEntityRepository
{
    ...
    public function add(CtMarque $entity, bool $flush = false): void
    {
    ...
    public function remove(CtMarque $entity, bool $flush = false): void
    {
